...
| [Podwise](https://podwise.xyz?ref=fndxchris) | Designed specifically for podcast listeners, an AI knowledge management application. | Mac Apps | **60%** off with code XMAS23 |